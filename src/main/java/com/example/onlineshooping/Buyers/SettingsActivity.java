...
public class SettingsActivity extends AppCompatActivity {
    ...
    private void userInfoDisplay(final CircleImageView profileImageView, final EditText fullNameEditText, final EditText userNameEditText, final EditText addressEditText)
    {
